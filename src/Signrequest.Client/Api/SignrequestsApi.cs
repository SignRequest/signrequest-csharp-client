...
namespace Signrequest.Client.Api
{
    ...
    public partial class SignrequestsApi : ISignrequestsApi
    {
        ...
        /// <returns></returns>
        public SignrequestsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< InlineResponse2005 > SignrequestsListWithHttpInfo (string who = null, string fromEmail = null, int? page = null, int? limit = null)
        {
            ...
            if (fromEmail != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "from_email", fromEmail)); // query parameter
