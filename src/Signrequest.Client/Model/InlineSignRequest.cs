...
namespace Signrequest.Client.Model
{
    ...
    public partial class InlineSignRequest :  IEquatable<InlineSignRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineSignRequest" /> class.
        /// </summary>
        /// <param name="RequiredAttachments">RequiredAttachments.</param>
        /// <param name="Signers">Signers.</param>
        public InlineSignRequest(List<RequiredAttachment> RequiredAttachments = default(List<RequiredAttachment>), List<Signer> Signers = default(List<Signer>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineSignRequest {\n");
        ...
        {
            return this.Equals(input as InlineSignRequest);
        }

        /// <summary>
        /// Returns true if InlineSignRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineSignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineSignRequest input)
        {
            if (input == null)
                return false;
