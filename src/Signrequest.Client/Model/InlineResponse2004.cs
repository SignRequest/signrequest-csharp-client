...
namespace Signrequest.Client.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(int? Count = default(int?), string Next = default(string), string Previous = default(string), List<ModelEvent> Results = default(List<ModelEvent>))
        {
