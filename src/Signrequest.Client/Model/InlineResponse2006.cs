...
namespace Signrequest.Client.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(int? Count = default(int?), string Next = default(string), string Previous = default(string), List<TeamMember> Results = default(List<TeamMember>))
        {
