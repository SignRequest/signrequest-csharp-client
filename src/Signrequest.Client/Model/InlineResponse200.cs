...
namespace Signrequest.Client.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(int? Count = default(int?), string Next = default(string), string Previous = default(string), List<AuthToken> Results = default(List<AuthToken>))
        {
        ...
        public List<AuthToken> Results { get; set; }
