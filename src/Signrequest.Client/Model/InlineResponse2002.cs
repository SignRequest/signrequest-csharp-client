...
namespace Signrequest.Client.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(int? Count = default(int?), string Next = default(string), string Previous = default(string), List<DocumentSearch> Results = default(List<DocumentSearch>))
        {
        ...
        public List<DocumentSearch> Results { get; set; }
