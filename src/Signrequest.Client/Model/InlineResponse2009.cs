...
namespace Signrequest.Client.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(int? Count = default(int?), string Next = default(string), string Previous = default(string), List<WebhookSubscription> Results = default(List<WebhookSubscription>))
        {
        ...
        public List<WebhookSubscription> Results { get; set; }
