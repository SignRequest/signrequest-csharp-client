...
namespace Signrequest.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineTeam :  IEquatable<InlineTeam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineTeam" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineTeam);
        }

        /// <summary>
        /// Returns true if InlineTeam instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineTeam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineTeam input)
        {
            if (input == null)
                return false;
