...
namespace SignRequest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentSigningLog :  IEquatable<DocumentSigningLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentSigningLog" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public DocumentSigningLog()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentSigningLog {\n");
        ...
        {
            return this.Equals(input as DocumentSigningLog);
        }

        /// <summary>
        /// Returns true if DocumentSigningLog instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentSigningLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentSigningLog input)
        {
            if (input == null)
                return false;
